...
Write a C program to delete the student's details from the end of the Linked List.
...
delatend() --- to delete student's details from the end of the linked list. Print "The linked list is empty" if the list is empty. Return 0 if the list is empty, else 1.
